...
(function() {
    ...
    function download(data, filename, type) {
        ...
        var file = new _Blob([String.fromCharCode(0xFEFF), data], {type: type}); 
    ...
    function addDocumentControls() {
        ...
        var docControlsStr =
            ...
            <div id="github-link">     
                <a class="github-button" href="https://github.com/99002684/WebDev_MiniProj" data-size="large" data-show-count="true" aria-label="Star Tombarr/html-resume-template on GitHub">Star</a>
            </div>`;
